...
<head>
<meta charset="utf-8">
<title>Willies - Real Estate HTML Template | My Properties</title>
<!-- Stylesheets -->
    ...
    <section class="hidden-bar">
        <div class="dashboard-inner">
        	...
        	<ul class="navigation">
	            ...
	            <li class="active"><a href="my-properties.html"><i class="pe-7s-diamond"></i>My Properties</a></li>
	                ...
	                <div class="row">
	                    <div class="column col-lg-12">
	                    	<div class="properties-box">
	                    		<div class="title"><h3>My Properties List</h3></div>
