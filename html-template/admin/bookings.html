...
<!-- Mirrored from expert-themes.com/html/willies/admin/bookings.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 11 Dec 2018 11:41:10 GMT -->
<head>
<meta charset="utf-8">
<title>Willies - Real Estate HTML Template | Bookings</title>
<!-- Stylesheets -->
    ...
    <section class="hidden-bar">
        <div class="dashboard-inner">
        	...
        	<ul class="navigation">
	            ...
	            <li class="active"><a href="bookings.html"><i class="pe-7s-date"></i>Bookings</a></li>
	        ...
	        <div class="content-area">
	            <div class="dashboard-content">
	                <div class="dashboard-header clearfix">
	                    <div class="row">
	                        <div class="col-md-6 col-sm-12"><h4>Bookings</h4></div>
	                                ...
	                                <article class="message-box">
	                                    ...
	                                    <div class="content-box">
	                                        ...
	                                        <ul class="booking-info">
	                                        	<li><strong>Item </strong> Real Luxury Villa</li>
	                                        	<li><strong>Start date </strong> 18 November 2018</li>
	                                        	<li><strong>End date </strong> 18 November 2018</li>
	                                        	<li><strong>Booking details </strong> 4 Peoples</li>
